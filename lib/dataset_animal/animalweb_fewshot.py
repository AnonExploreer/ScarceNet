...
from dataset_animal import animalweb_info
...
class AnimalAnimalWebDataset(Kpt2dSviewRgbImgTopDownDataset):
    ...
    def __init__(self,
        ...
        if image_set == 'train':
            ...
            ann_file = "data/AnimalWeb/all.json"
        elif image_set == 'val':
            logger.info('Loading validation annotations')
            ann_file = "data/AnimalWeb/all_150.json"
        else:
            logger.info('Loading testing annotations')
            ann_file = "data/AnimalWeb/test_40_known.json"
        ...
        self.id2name, self.name2id = self._get_mapping_id_name(
            self.coco.imgs)
        dataset_info = animalweb_info.dataset_info
        dataset_info = DatasetInfo(dataset_info)
        self.num_joints = 9
        self.flip_pairs = [[1,2],[0,3],[5,6]]
        ...
        if self.few_shot_setting and image_set == 'train':
            ...
            with open('data/AnimalWeb/train_40img.json', 'r') as fp:
    ...
    def _load_coco_keypoint_annotation_kernel(self, img_id):
        ...
        for obj in objs:
            ...
            image_file = os.path.join('/home/shanchuan/data/animal_dataset_v1_c/animal_dataset_v1_clean_check', self.id2name[img_id])
            rec.append({
    ...
    def evaluate(self, cfg, preds, output_dir, all_boxes, img_path,
        ...
        for idx, kpt in enumerate(preds):
            image_name = img_path[idx].split('/')[-1]
